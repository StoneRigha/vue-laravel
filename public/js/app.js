...
Vue.use(vue_axios__WEBPACK_IMPORTED_MODULE_1__["default"], (axios__WEBPACK_IMPORTED_MODULE_2___default()));
var app = new Vue(vue.util.extend((_App_vue__WEBPACK_IMPORTED_MODULE_0___default()))).$mount('#app');
